...
$validextensions_file = array("py","pkl");
		...
		else
		{
			...
			{*/
				...
				if($file_extension == "py")
					$targetPath = "C:/xampp/htdocs/CNN_Project/python/test.py";
				else
					$targetPath = "C:/xampp/htdocs/CNN_Project/python/params.pkl";// . $file_extension; // Target path where file is to be stored
